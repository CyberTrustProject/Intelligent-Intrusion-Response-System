...
function transformGraph(data) {
    ...
    var arrayNodesID = [];
    var indexMatchTable = [];
    var indexMatchTableTest1 = [];
	var indexMatchTableTest2 = [];
...
/*  for(i=0; i < sizeLinks; ++i){
	...
	console.log(source + "with" + target);
	//indexMatchTableTest1.push(source);
	//indexMatchTableTest2.push(target);	
	...
	for(i=0; i < sizeLinks; i++){
		if(!arrayNodesID.includes(indexMatchTableTest1[i])){
			arrayNodesID.push(indexMatchTableTest1[i]);
		}
		if(!arrayNodesID.includes(indexMatchTableTest2[i])){
			arrayNodesID.push(indexMatchTableTest2[i]);
		}
	}
	//console.log("2 yes");
	//console.log(indexMatchTableTest1);
	//console.log(indexMatchTableTest2);
	//console.log(arrayNodesID);
	var cou=0;
	//console.log(data.attack_graph.vertices.vertex);
	...
	//console.log(graphAttackDatas.nodes);	
	//console.log(cou);
	//console.log("3 yes");
	//counter=0;
    ...
    for(i=0; i < sizeLinks; i++){
     ...
     //   source = data.attack_graph.arcs.arc[i].src;
        ...
        var link = {source: (indexMatchTableTest1[i])-1, target: (indexMatchTableTest2[i])-1};
	//console.log(link);
...
function transformGraphTopo(data){
    ...
    for(i=0; i < arrayNodesID.length; ++i) {
        ...
        var nodeAttackGraph = data.vertices.vertex[arrayNodesID[i]];
	console.log(data.vertices.vertex[i]);
        if(data.vertices.vertex[i].target){
            icone = 0;
        }
        else if(data.vertices.vertex[i].source_of_attack){
		if(data.vertices.vertex[i].name == "internet_host"){
			icone = 6;
		}
		else{	
            		icone = 1;
