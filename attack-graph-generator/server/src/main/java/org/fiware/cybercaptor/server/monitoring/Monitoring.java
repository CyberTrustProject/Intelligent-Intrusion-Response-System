...
public class Monitoring {
    ...
    private RemediationCostParameters remediationCostParameters = new RemediationCostParameters();
    ...
    public RemediationCostParameters getRemediationCostParameters() {
        return remediationCostParameters;
    }
