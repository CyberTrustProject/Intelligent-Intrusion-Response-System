...
public class InformationSystemHost extends Host {
    ...
    public void loadFromDomElement(Element domElement, Topology topology, Database db) throws Exception {
        ...
        Element host_cpe = domElement.getChild("cpe");
        if ((host_cpe != null)) {
            this.setCpe(host_cpe.getText());
        }
        ...
        if (servicesElement != null) {
            ...
            for (Element serviceElement : servicesElementList) {
                ...
                if (serviceNameElement != null) {
                    ...
                    Element serviceCpeElement = null;
                    try {
                        serviceCpeElement = serviceElement.getChild("cpe");
                        if(serviceCpeElement != null)
                            service.setCPE(serviceCpeElement.getText());
                    } catch (Exception e) {
                        Logger.getAnonymousLogger().info("Host does not have a CPE identifier specified.");
                    }
