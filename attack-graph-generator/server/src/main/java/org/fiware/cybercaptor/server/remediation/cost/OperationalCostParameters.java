...
public class OperationalCostParameters {
    ...
    public Element toDomElement() {
        ...
        Element businessApplicationsTestsDurationElement = new Element("AvailabilityVsSecurityTradeOff");
        ...
        //remediationCost
        Element remediationCostElement = new Element("ServiceRemediationCost");
        remediationCostElement.setText(getRemediationCost() + "");
        root.addContent(remediationCostElement);

        //computationPowerCost
        Element computationPowerCostElement = new Element("PerformanceVsSecurityTradeOff");
        ...
        Element serviceUnavailabilityDeploymentDurationElement = new Element("ServiceUnavailabilityCost");
    ...
    /**
     * Load the Operational cost parameters from a XML DOM Document
     *
    ...
    public void loadFromDomDocument(Document document) {
        ...
        //remediationCost
        Element remediationCostElement = root.getChild("ServiceRemediationCost");
        if (remediationCostElement != null)
            setRemediationCost(Double.parseDouble(remediationCostElement.getText()));

        //businessApplicationsTestsDuration
        Element businessApplicationsTestsDurationElement = root.getChild("AvailabilityVsSecurityTradeOff");
        ...
        //computationPowerCost
        Element computationPowerCostElement = root.getChild("PerformanceVsSecurityTradeOff");
        ...
        //serviceUnavailabilityDeploymentDuration
        Element serviceUnavailabilityDeploymentDurationElement = root.getChild("ServiceUnavailabilityCost");
